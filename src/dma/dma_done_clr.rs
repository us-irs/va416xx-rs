...
pub struct R(crate::R<DMA_DONE_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_DONE_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_DONE_CLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_DONE_CLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_DONE_CLR` writer"]
pub struct W(crate::W<DMA_DONE_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_DONE_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_DONE_CLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_DONE_CLR_SPEC>) -> Self {
        W(writer)
    }
}
