...
pub struct R(crate::R<RXWDOGERROR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXWDOGERROR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXWDOGERROR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXWDOGERROR_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct RXWDOGERROR_SPEC;
impl crate::RegisterSpec for RXWDOGERROR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rxwdogerror::R](R) reader structure"]
impl crate::Readable for RXWDOGERROR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RXWDOGERROR to value 0"]
impl crate::Resettable for RXWDOGERROR_SPEC {
    #[inline(always)]
