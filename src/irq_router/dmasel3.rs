...
pub struct R(crate::R<DMASEL3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMASEL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMASEL3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMASEL3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMASEL3` writer"]
pub struct W(crate::W<DMASEL3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMASEL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMASEL3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMASEL3_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Interrupt select for DMA channel 3\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dmasel3](index.html) module"]
pub struct DMASEL3_SPEC;
impl crate::RegisterSpec for DMASEL3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dmasel3::R](R) reader structure"]
impl crate::Readable for DMASEL3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmasel3::W](W) writer structure"]
impl crate::Writable for DMASEL3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMASEL3 to value 0x7f"]
impl crate::Resettable for DMASEL3_SPEC {
    #[inline(always)]
