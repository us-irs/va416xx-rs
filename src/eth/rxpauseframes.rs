...
pub struct R(crate::R<RXPAUSEFRAMES_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXPAUSEFRAMES_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXPAUSEFRAMES_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXPAUSEFRAMES_SPEC>) -> Self {
        R(reader)
    }
}
