...
pub struct R(crate::R<TX1024MAXOCT_GB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TX1024MAXOCT_GB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TX1024MAXOCT_GB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TX1024MAXOCT_GB_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct TX1024MAXOCT_GB_SPEC;
impl crate::RegisterSpec for TX1024MAXOCT_GB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tx1024maxoct_gb::R](R) reader structure"]
impl crate::Readable for TX1024MAXOCT_GB_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TX1024MAXOCT_GB to value 0"]
impl crate::Resettable for TX1024MAXOCT_GB_SPEC {
    #[inline(always)]
