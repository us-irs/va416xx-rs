...
pub struct R(crate::R<TX128TO255OCT_GB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TX128TO255OCT_GB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TX128TO255OCT_GB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TX128TO255OCT_GB_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct TX128TO255OCT_GB_SPEC;
impl crate::RegisterSpec for TX128TO255OCT_GB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tx128to255oct_gb::R](R) reader structure"]
impl crate::Readable for TX128TO255OCT_GB_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TX128TO255OCT_GB to value 0"]
impl crate::Resettable for TX128TO255OCT_GB_SPEC {
    #[inline(always)]
