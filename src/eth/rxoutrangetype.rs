...
pub struct R(crate::R<RXOUTRANGETYPE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXOUTRANGETYPE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXOUTRANGETYPE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXOUTRANGETYPE_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct RXOUTRANGETYPE_SPEC;
impl crate::RegisterSpec for RXOUTRANGETYPE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rxoutrangetype::R](R) reader structure"]
impl crate::Readable for RXOUTRANGETYPE_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RXOUTRANGETYPE to value 0"]
impl crate::Resettable for RXOUTRANGETYPE_SPEC {
    #[inline(always)]
