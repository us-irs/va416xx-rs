...
pub struct R(crate::R<TXMCASTFRAME_GB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXMCASTFRAME_GB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXMCASTFRAME_GB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXMCASTFRAME_GB_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct TXMCASTFRAME_GB_SPEC;
impl crate::RegisterSpec for TXMCASTFRAME_GB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [txmcastframe_gb::R](R) reader structure"]
impl crate::Readable for TXMCASTFRAME_GB_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TXMCASTFRAME_GB to value 0"]
impl crate::Resettable for TXMCASTFRAME_GB_SPEC {
    #[inline(always)]
