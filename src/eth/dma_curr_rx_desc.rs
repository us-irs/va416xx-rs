...
pub struct R(crate::R<DMA_CURR_RX_DESC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_CURR_RX_DESC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_CURR_RX_DESC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_CURR_RX_DESC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_CURR_RX_DESC` writer"]
pub struct W(crate::W<DMA_CURR_RX_DESC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_CURR_RX_DESC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_CURR_RX_DESC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_CURR_RX_DESC_SPEC>) -> Self {
        W(writer)
    }
}
