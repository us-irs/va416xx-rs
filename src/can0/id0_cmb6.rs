...
pub struct R(crate::R<ID0_CMB6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ID0_CMB6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ID0_CMB6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ID0_CMB6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ID0_CMB6` writer"]
pub struct W(crate::W<ID0_CMB6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ID0_CMB6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ID0_CMB6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ID0_CMB6_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CAN Frame Identifier Word 0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [id0_cmb6](index.html) module"]
pub struct ID0_CMB6_SPEC;
impl crate::RegisterSpec for ID0_CMB6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [id0_cmb6::R](R) reader structure"]
impl crate::Readable for ID0_CMB6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [id0_cmb6::W](W) writer structure"]
impl crate::Writable for ID0_CMB6_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ID0_CMB6 to value 0"]
impl crate::Resettable for ID0_CMB6_SPEC {
    #[inline(always)]
