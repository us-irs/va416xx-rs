...
pub struct R(crate::R<RXUCASTFRAMES_G_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXUCASTFRAMES_G_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXUCASTFRAMES_G_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXUCASTFRAMES_G_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct RXUCASTFRAMES_G_SPEC;
impl crate::RegisterSpec for RXUCASTFRAMES_G_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rxucastframes_g::R](R) reader structure"]
impl crate::Readable for RXUCASTFRAMES_G_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RXUCASTFRAMES_G to value 0"]
impl crate::Resettable for RXUCASTFRAMES_G_SPEC {
    #[inline(always)]
