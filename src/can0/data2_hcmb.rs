...
pub struct R(crate::R<DATA2_HCMB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DATA2_HCMB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DATA2_HCMB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DATA2_HCMB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DATA2_HCMB` writer"]
pub struct W(crate::W<DATA2_HCMB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATA2_HCMB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATA2_HCMB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATA2_HCMB_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CAN Frame Data Word 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [data2_hcmb](index.html) module"]
pub struct DATA2_HCMB_SPEC;
impl crate::RegisterSpec for DATA2_HCMB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [data2_hcmb::R](R) reader structure"]
impl crate::Readable for DATA2_HCMB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [data2_hcmb::W](W) writer structure"]
impl crate::Writable for DATA2_HCMB_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DATA2_HCMB to value 0"]
impl crate::Resettable for DATA2_HCMB_SPEC {
    #[inline(always)]
