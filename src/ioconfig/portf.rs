#[doc = "Register `PORTF[%s]` reader"]
pub struct R(crate::R<PORTF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PORTF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PORTF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PORTF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PORTF[%s]` writer"]
pub struct W(crate::W<PORTF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PORTF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PORTF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PORTF_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct PORTF_SPEC;
impl crate::RegisterSpec for PORTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [portf::R](R) reader structure"]
impl crate::Readable for PORTF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [portf::W](W) writer structure"]
impl crate::Writable for PORTF_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PORTF[%s]
to value 0"]
impl crate::Resettable for PORTF_SPEC {
    #[inline(always)]
