...
pub struct R(crate::R<ID1_CMB4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ID1_CMB4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ID1_CMB4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ID1_CMB4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ID1_CMB4` writer"]
pub struct W(crate::W<ID1_CMB4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ID1_CMB4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ID1_CMB4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ID1_CMB4_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CAN Frame Identifier Word 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [id1_cmb4](index.html) module"]
pub struct ID1_CMB4_SPEC;
impl crate::RegisterSpec for ID1_CMB4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [id1_cmb4::R](R) reader structure"]
impl crate::Readable for ID1_CMB4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [id1_cmb4::W](W) writer structure"]
impl crate::Writable for ID1_CMB4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ID1_CMB4 to value 0"]
impl crate::Resettable for ID1_CMB4_SPEC {
    #[inline(always)]
