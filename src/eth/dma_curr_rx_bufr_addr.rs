...
pub struct R(crate::R<DMA_CURR_RX_BUFR_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_CURR_RX_BUFR_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_CURR_RX_BUFR_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_CURR_RX_BUFR_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_CURR_RX_BUFR_ADDR` writer"]
pub struct W(crate::W<DMA_CURR_RX_BUFR_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_CURR_RX_BUFR_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_CURR_RX_BUFR_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_CURR_RX_BUFR_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Contains the current Receive Buffer address read by the DMA\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_curr_rx_bufr_addr](index.html) module"]
pub struct DMA_CURR_RX_BUFR_ADDR_SPEC;
impl crate::RegisterSpec for DMA_CURR_RX_BUFR_ADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_curr_rx_bufr_addr::R](R) reader structure"]
impl crate::Readable for DMA_CURR_RX_BUFR_ADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_curr_rx_bufr_addr::W](W) writer structure"]
impl crate::Writable for DMA_CURR_RX_BUFR_ADDR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMA_CURR_RX_BUFR_ADDR to value 0"]
impl crate::Resettable for DMA_CURR_RX_BUFR_ADDR_SPEC {
    #[inline(always)]
