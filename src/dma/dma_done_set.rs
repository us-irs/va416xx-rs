...
pub struct R(crate::R<DMA_DONE_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_DONE_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_DONE_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_DONE_SET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_DONE_SET` writer"]
pub struct W(crate::W<DMA_DONE_SET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_DONE_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_DONE_SET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_DONE_SET_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "DMA done set\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_done_set](index.html) module"]
pub struct DMA_DONE_SET_SPEC;
impl crate::RegisterSpec for DMA_DONE_SET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_done_set::R](R) reader structure"]
impl crate::Readable for DMA_DONE_SET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_done_set::W](W) writer structure"]
impl crate::Writable for DMA_DONE_SET_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMA_DONE_SET to value 0"]
impl crate::Resettable for DMA_DONE_SET_SPEC {
    #[inline(always)]
