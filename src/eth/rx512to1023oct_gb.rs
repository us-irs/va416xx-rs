...
pub struct R(crate::R<RX512TO1023OCT_GB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RX512TO1023OCT_GB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RX512TO1023OCT_GB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RX512TO1023OCT_GB_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct RX512TO1023OCT_GB_SPEC;
impl crate::RegisterSpec for RX512TO1023OCT_GB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rx512to1023oct_gb::R](R) reader structure"]
impl crate::Readable for RX512TO1023OCT_GB_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RX512TO1023OCT_GB to value 0"]
impl crate::Resettable for RX512TO1023OCT_GB_SPEC {
    #[inline(always)]
