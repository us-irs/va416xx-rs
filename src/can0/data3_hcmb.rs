...
pub struct R(crate::R<DATA3_HCMB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DATA3_HCMB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DATA3_HCMB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DATA3_HCMB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DATA3_HCMB` writer"]
pub struct W(crate::W<DATA3_HCMB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATA3_HCMB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATA3_HCMB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATA3_HCMB_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CAN Frame Data Word 3\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [data3_hcmb](index.html) module"]
pub struct DATA3_HCMB_SPEC;
impl crate::RegisterSpec for DATA3_HCMB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [data3_hcmb::R](R) reader structure"]
impl crate::Readable for DATA3_HCMB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [data3_hcmb::W](W) writer structure"]
impl crate::Writable for DATA3_HCMB_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DATA3_HCMB to value 0"]
impl crate::Resettable for DATA3_HCMB_SPEC {
    #[inline(always)]
