...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn portc0(&self, n: usize) -> &Portc {
        &self.portc0[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x80..0xc0 - PORTC Pin Configuration Register"]
    #[inline(always)]
    pub fn portc0_iter(&self) -> impl Iterator<Item = &Portc> {
        self.portc0.iter()
    }
    #[doc = "0xc0..0x100 - PORTD Pin Configuration Register"]
    #[inline(always)]
    pub const fn portd0(&self, n: usize) -> &Portd {
        &self.portd0[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0xc0..0x100 - PORTD Pin Configuration Register"]
    #[inline(always)]
    pub fn portd0_iter(&self) -> impl Iterator<Item = &Portd> {
        self.portd0.iter()
    }
    #[doc = "0x100..0x140 - PORTE Pin Configuration Register"]
    #[inline(always)]
    pub const fn porte0(&self, n: usize) -> &Porte {
        &self.porte0[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x100..0x140 - PORTE Pin Configuration Register"]
    #[inline(always)]
    pub fn porte0_iter(&self) -> impl Iterator<Item = &Porte> {
        self.porte0.iter()
    }
    #[doc = "0x140..0x180 - PORTF Pin Configuration Register"]
    #[inline(always)]
    pub const fn portf0(&self, n: usize) -> &Portf {
        &self.portf0[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x140..0x180 - PORTF Pin Configuration Register"]
    #[inline(always)]
    pub fn portf0_iter(&self) -> impl Iterator<Item = &Portf> {
        self.portf0.iter()
    }
    #[doc = "0x180..0x1a0 - PORTG Pin Configuration Register"]
    #[inline(always)]
    pub const fn portg0(&self, n: usize) -> &Portg {
        &self.portg0[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x180..0x1a0 - PORTG Pin Configuration Register"]
    #[inline(always)]
    pub fn portg0_iter(&self) -> impl Iterator<Item = &Portg> {
        self.portg0.iter()
    }
