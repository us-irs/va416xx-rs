...
pub struct R(crate::R<RXMCASTFRAMES_G_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXMCASTFRAMES_G_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXMCASTFRAMES_G_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXMCASTFRAMES_G_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct RXMCASTFRAMES_G_SPEC;
impl crate::RegisterSpec for RXMCASTFRAMES_G_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rxmcastframes_g::R](R) reader structure"]
impl crate::Readable for RXMCASTFRAMES_G_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RXMCASTFRAMES_G to value 0"]
impl crate::Resettable for RXMCASTFRAMES_G_SPEC {
    #[inline(always)]
