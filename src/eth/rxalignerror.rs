...
pub struct R(crate::R<RXALIGNERROR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXALIGNERROR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXALIGNERROR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXALIGNERROR_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct RXALIGNERROR_SPEC;
impl crate::RegisterSpec for RXALIGNERROR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rxalignerror::R](R) reader structure"]
impl crate::Readable for RXALIGNERROR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RXALIGNERROR to value 0"]
impl crate::Resettable for RXALIGNERROR_SPEC {
    #[inline(always)]
